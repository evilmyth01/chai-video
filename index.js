...
app.post("/upload", upload.single('file'), async function(req, res){
    ...
    try {
      ...
      writer.on('finish', () => {
        ...
        const ffmpegCommand = `ffmpeg -i ${tempVideoPath} -vf "scale=1280:720" -codec:v libx264 -codec:a aac -hls_time 10 -hls_playlist_type vod -hls_segment_filename "${outputPath}/segment%03d.ts" -start_number 0 ${hlsPath}`;
